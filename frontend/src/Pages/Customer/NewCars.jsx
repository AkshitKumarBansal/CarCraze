...
const NewCars = () => {
  ...
  const limit = 12; // Number of cars per page
    ...
    const fetchCars = async () => {
      try {
        ...
        const queryParams = new URLSearchParams({
          ...
          sortBy,
          sortOrder,
          listingType: 'sale_new', // Crucial: Tell backend to only return new cars
          ...(search && { search }),
        ...
        // Extract pagination metadata from the backend response
        if (data?.pagination) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8 pt-24">
      <div className="max-w-7xl mx-auto">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-2 mt-4 pt-4">New Cars</h1>
        <p className="text-gray-600 mb-8 text-lg sm:text-2xl pt-4">Browse the latest brand new cars available.</p>
        ...
        <div className="mt-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">All New Cars</h2>
          
          {loading && <div className="text-center py-12 text-gray-500 font-medium text-lg animate-pulse">Loading new cars...</div>}
